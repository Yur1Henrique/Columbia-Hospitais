...
<html>
    <head>
        <title>Columbia Hospitais</title>
        <meta charset="UTF-8">
    ...
    <body>
        <header class="clearfix">
            <img src="icone.png" alt="Logo Columbia Hospitais" class="logo">
            <nav class="menu">
                <ul>
                    <li><a>Barra de Pesquisa</a></li>
                    <li><a href="#">Informações de Atendimento</a></li>
        ...
        <main>
            <div id="login" class="tabcontent">
                <div id="meio" class="FixoDireita FonteOswald">
                    ...
                    <input id="nomeComp" type="text" class="txt2" name="primeiroNome" placeholder="Digite seu nome completo" >

                    <div class="txte" aria-hidden="true">Email</div>
                    <input id="email" type="text" class="txt2" name="reg_email" placeholder="exemplo@exemplo.com">

                    <div class="txte">CPF</div>
                    <input id="cpf" type="text" class="txt2" name="CPF" onkeypress="this.value = FormataCpf(event)" onpaste="return false;" maxlength="14" placeholder="000.111.222-33">

                    <div class="txte">RG</div>
                    <input id="rg" type="text" class="txt2" name="RG" onkeypress="this.value = FormataRg(event)" onpaste="return false;" maxlength="12" placeholder="00.111.222-X">

                    <div class="txte">Numero do convênio</div>
                    <input id="regConvenio" type="text" class="txt2" name="regConvenio" placeholder="Digite o numero do seu convênio">

                    <div class="txte">Data de Nascimento</div>

                    <select name="birthday_day" id="dia" title="Dia" class="txte FonteOswald">
                    ...
                    <select aria-label="Mês" name="birthday_month" id="mes" title="Mês" class="txte FonteOswald">
                    ...
                    <select aria-label="Ano" name="birthday_year" id="ano" title="Ano" class="txte FonteOswald">
                    ...
                    <div class="txte">
                        <input type="radio" name="sex" value="1" id="sexoF">
                        <label class="txte" for="sexoF">Feminino</label>
                        <input type="radio" name="sex" value="2" id="sexoM">
                        <label class="txte" for="sexoM">Masculino</label>
                    </div>
            ...
            <ul class="tab">
              <li><a href="javascript:void(0)" class="tablinks"  onclick="abrirForm(event, 'login')">Login</a></li>
              <li><a href="javascript:void(0)" class="tablinks" id="defaultOpen" onclick="abrirForm(event, 'cadastro')">Cadastre-se</a></li>
            </ul>
